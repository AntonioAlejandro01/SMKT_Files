...
import com.antonioalejandro.smkt.files.excel.enums.*;
...
public abstract class ExcelBookAbstract<T extends IExcelObject> {
	...
	/**
	 * A�ade el logo en formato byte[]. En caso de que se establezcan los logos con
	...
	/**
	 * A�ade el logo en formato InputStream. En caso de que se establezcan los logos
	...
	/**
	 * Cierra el excel y no se pueden hacer a�adir mas datos
	 *
	 * @throws IOException
	 */
	...
	/**
	 * Ajusta las columnas al tama�o de los datos
	 *
	 * @param num
	 */
